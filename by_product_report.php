	...
	<div class="col-md-12">
		<div class="panel panel-default">
			<div class="panel-heading">
				<i class="glyphicon glyphicon-check"></i>	Order Report By Product
			</div>
			<!-- /panel-heading -->
			<div class="panel-body">
				
				<form class="form-horizontal" action="php_action/getbyproductreport.php" method="post" id="getOrderReportForm">
...
<script src="custom/js/byproductreport.js"></script>
