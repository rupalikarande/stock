			  ...
			  <table class="table" id="productTable">
			  	<thead>
			  		<tr>			  			
			  			...
			  			<th style="width:15%; padding-left:100px;">Rate</th>
			  			<th style="width:10%; padding-left:30px;">Quantity</th>			  			
						<th style="width:10%; padding-left:20px;">GST Amount</th>	
			  			<th style="width:15%; padding-left:80px;">Total</th>
			  	...
			  	<tbody>
			  		...
			  		for($x = 1; $x < 4; $x++) { ?>
			  			<tr id="row<?php echo $x; ?>" class="<?php echo $arrayNumber; ?>">			  				
							...
							<td style="padding-left:28px;">
			  					<div class="form-group">
			  					<input type="number" name="gst[]" id="gst<?php echo $x; ?>" onkeyup="getTotal(<?php echo $x ?>)" autocomplete="off" class="form-control" min="1" />
			  					</div>
			  				</td>
			  				<td style="padding-left:20px;">			  					
