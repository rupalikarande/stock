...
require_once ('includes/headercustom.php'); 
...
<div class="panel panel-default">
	...
	<div class="success-messages"></div> <!--/success-messages-->
  		...
  		<form class="form-horizontal" method="POST" action="php_action/createinvoice.php" id="printinvoice">
			  ...
			  <div class="form-group">
				...
				<label for="clientName" class="col-sm-2 control-label">Place of Supply</label>
				 <div class="col-sm-4">
			      <input type="text" class="form-control" id="placeos" name="placeos" placeholder="Place of Supply" autocomplete="on" required/>
			    </div>
			  </div> <!--/form-group-->
			<hr><!--biiled to-->  
			<div class="form-group">
			    ...
			    <div class="col-sm-4">
			      <input type="text" class="form-control" id="name" name="name" placeholder="Name" autocomplete="on" required/>
			    </div>
				<label for="clientName" class="col-sm-2 control-label">address</label>
				 <div class="col-sm-4">
			      <input type="text" class="form-control" id="address" name="address" placeholder="address" autocomplete="on" required/>
			    </div>
			  ...
			  <label for="clientName" class="col-sm-2 control-label">country</label>
				 <div class="col-sm-4">
			      <input type="text" class="form-control" id="country" name="country" placeholder="country" autocomplete="on" required/>
			    </div>
				<label for="clientName" class="col-sm-2 control-label">Contact</label>
				 <div class="col-sm-4">
			      <input type="text" class="form-control" id="contact" name="contact" placeholder="contact no" autocomplete="on" required/>
			    </div>
				</div>
				<div class="form-group">
				  <label for="clientName" class="col-sm-2 control-label">GSTIN</label>
					 <div class="col-sm-4">
					  <input type="text" class="form-control" id="gstin_bill" name="gstin_bill" placeholder="GSTIN" autocomplete="on" required/>
					</div>
			    ...
			    <label for="clientName" class="col-sm-2 control-label">Name</label>
			    <div class="col-sm-4">
			      <input type="text" class="form-control" id="ship_name" name="ship_name" placeholder="Name" autocomplete="on" required/>
			    </div>
				<label for="clientName" class="col-sm-2 control-label">address</label>
				 <div class="col-sm-4">
			      <input type="text" class="form-control" id="ship_address" name="ship_address" placeholder="address" autocomplete="on" required/>
			    </div>
			  ...
			  <label for="clientName" class="col-sm-2 control-label">country</label>
				 <div class="col-sm-4">
			      <input type="text" class="form-control" id="ship_country" name="ship_country" placeholder="country" autocomplete="on" required/>
			    </div>
				</div>
				<div class="form-group">
				  <label for="clientName" class="col-sm-2 control-label">GSTIN</label>
					 <div class="col-sm-4">
					  <input type="text" class="form-control" id="gstin_ship" name="gstin_ship" placeholder="GSTIN" autocomplete="on" required/>
					</div>
			  ...
			  <table class="table" id="productTable">
			  	<thead>
			  		<tr>			  			
						...
						<th style="width:10%; padding-left:30px;">CGST <input type="checkbox"  id="gsttrue" value="cgsttrue" ></th>
						
						<th style="width:9%; padding-left:30px;">SGST  <input type="checkbox" id="sgsttrue" value="sgsttrue"></th>
						<th style="width:9%; padding-left:30px;">IGST  <input type="checkbox" id="igsttrue" value="igsttrue"></th>			  			
