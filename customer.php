...
<div class="modal fade" id="addProductModal" tabindex="-1" role="dialog">
  <div class="modal-dialog">
    <div class="modal-content">
    	...
    	<form class="form-horizontal" id="submitProductForm" action="php_action/createCustomer.php" method="POST" enctype="multipart/form-data">
	      ...
	      <div class="modal-body" style="max-height:450px; overflow:auto;">
	      	...
	      	<!-- <div class="form-group">
	        	<label for="productImage" class="col-sm-3 control-label"> Customer Image: </label>
	        ...
	        <div class="form-group">
	        	...
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <input type="number" class="form-control" id="ContactNo" placeholder="Contact Number" name="ContactNo" autocomplete="off">
				    </div>
	        </div> <!-- /form-group-->	    
					...
					<!-- <div class="form-group">
					<label for="SameasAbove" class="col-sm-6 control-label"> Same as Above</label>
					<input type="checkbox" name="SameasAbove" value="SameasAbove"> 
					</div>  /form-group   -->

          <div class="form-group">
	        	<label for="ContactName" class="col-sm-3 control-label"> Contact Preson Name</label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <input type="text" class="form-control" id="ContactName" placeholder="Contact Name" name="ContactName" autocomplete="off">
				    </div>
	        </div>  <!-- /form-group-->  

					<div class="form-group">
	        	<label for="ContactNum" class="col-sm-3 control-label"> Contact Preson Number</label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <input type="Number" class="form-control" id="ContactNum" placeholder="Contact No" name="ContactNum" autocomplete="off">
				    </div>
	        </div> <!-- /form-group-->  
          ...
          <div class="form-group">
	           ...
	           <div class="form-group">
	        	<label for="GST" class="col-sm-3 control-label">GST No </label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <input type="number" class="form-control" id="GST" placeholder="GST Number" name="GST" autocomplete="off">
				    </div>
	        </div> <!-- /form-group-->	 
	      ...
	      <div class="modal-footer">
	        ...
	        <button type="submit" class="btn btn-primary" name="save" id="createProductBtn" data-loading-text="Loading..." autocomplete="off"> <i class="glyphicon glyphicon-ok-sign"></i> Save Changes</button>
	      </div> <!-- /modal-footer -->	      
     	</form> <!-- /.form -->	     
    </div> <!-- /modal-content -->    
  </div> <!-- /modal-dailog -->
	      ...
	      <div class="modal-body" style="max-height:450px; overflow:auto;">
	      	...
	      	<div class="div-result">
				  ...
				  <ul class="nav nav-tabs" role="tablist">
				    ...
				    <li role="presentation"><a href="#productInfo" aria-controls="profile" role="tab" data-toggle="tab">Customer Info</a></li>    
				  </ul>
